const BACKEND_END = "http://localhost:8080";
...
async function getCars(){
    let array = await makeRequest(`${BACKEND_END}/cars`, 'get', {});
...
async function getUsers(){
    return await makeRequest(`${BACKEND_END}/users`, 'get', {});
}
getUsers();
